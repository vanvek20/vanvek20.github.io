...
window.SERVICES_DATA = {
  ...
  // ── ВЫЕЗД МАСТЕРА ──────────────────────────────────────────────────────
  'master-visit': {
    categoryName: 'Выезд мастера',
    services: [
      {
        id: 'master-visit-01', name: 'Выезд мастера по городу', price: 3000,
        desc: 'Выезд специалиста для осмотра, консультации и оценки объёма работ. За пределы города — обсуждается с менеджером',
        addons: []
      },
    ]
  },
