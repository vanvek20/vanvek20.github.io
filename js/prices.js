...
window.COMPANY_INFO = {
  ...
  description: 'Профессиональная установка сантехники в Москве по фиксированной цене. Онлайн-заказ без звонков. Выезд в день заказа. Гарантия 1 год. Официальный договор. Более 200 выполненных заказов. На рынке с 2022 года. Официальный партнёр гипермаркета Сантехника-онлайн.',
};
